...
- [07.VGG16调用](07.vgg-16.py)
- [08.卷积滤波器可视化](08.conv_filter_visualization.py)
- [09.变分自动编码器](09.variational_autoencoder.py)
- [10.锁定层fine-tuning网络](10.mnist_transfer_cnn.py)
- [11.使用sklearn wrapper进行的参数搜索](11.mnist_sklearn_wrapper.py)
- [12.Keras和Tensorflow联合使用](12.Keras_with_tensorflow.py)
- [13.Finetune InceptionV3样例](13.finetune_InceptionV3.py)
